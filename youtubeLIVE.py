...
{'type_id': 'CCTV国际中文亚洲台', 'type_name': 'CCTV国际中文亚洲台'},
{'type_id': '八度空间华语新闻LIVE', 'type_name': '八度空间华语新闻LIVE'},
{'type_id': 'CCTV13新闻频道LIVE', 'type_name': 'CCTV13新闻频道LIVE'},
{'type_id': 'Mediacorp Classics 官方频道', 'type_name': 'Mediacorp Classics 官方频道'},
{'type_id': '凤凰卫视资讯台', 'type_name': '凤凰卫视资讯台'},
{'type_id': '新唐人亚太台', 'type_name': '新唐人亚太台'},
{'type_id': 'TaiwanPlusNews live', 'type_name': 'TaiwanPlusNews live'},
{'type_id': 'Berita rtm live', 'type_name': 'Berita rtm live'},
{'type_id': 'AstroAwani live', 'type_name': 'AstroAwani live'},
{'type_id': 'CNA', 'type_name': 'CNA'},
{'type_id': 'cartoon LIVE', 'type_name': 'cartoon LIVE'},
{'type_id': '24/7 FEED', 'type_name': '24/7 FEED'},
{'type_id': 'Badminton (BWF LIVE)', 'type_name': 'Badminton (BWF LIVE)'},
{'type_id': '乒乓球现场直播', 'type_name': '乒乓球现场直播'},
{'type_id': '直播LIVE', 'type_name': '直播LIVE'},
{'type_id': '三立新闻台', 'type_name': '三立新闻台'},
{'type_id': '三立iNEWS', 'type_name': '三立iNEWS'},
{'type_id': 'TVBS新闻台', 'type_name': 'TVBS新闻台'},
{'type_id': '民视新闻台', 'type_name': '民视新闻台'},
{'type_id': '中天新闻台', 'type_name': '中天新闻台'},
{'type_id': '中视新闻台', 'type_name': '中视新闻台'},
{'type_id': '台视新闻台', 'type_name': '台视新闻台'},
{'type_id': '华视新闻台', 'type_name': '华视新闻台'},
{'type_id': '公视新闻台', 'type_name': '公视新闻台'},
{'type_id': '寰宇新闻台', 'type_name': '寰宇新闻台'},
{'type_id': '镜新闻台', 'type_name': '镜新闻台'},
{'type_id': '东森新闻台', 'type_name': '东森新闻台'},
{'type_id': '东森财经台', 'type_name': '东森财经台'},
{'type_id': '非凡新闻台', 'type_name': '非凡新闻台'},
{'type_id': '@NOWNEWS-AI-Anchor', 'type_name': 'AI主播倪珍24小时新闻直播'},
{'type_id': '8world新闻台', 'type_name': '8world新闻台'},
...
class Spider(Spider):
        ...
        for attempt, delay in enumerate((0, 0.25, 0.7), 1):
            ...
            try:
                ...
                if response is not None:
                    response.close()
                    response = None
            debug_log('hls proxy retry', {'key': key, 'kind': kind, 'attempt': attempt, 'error': repr(last_error)})
    ...
    def _refresh_hls_target(self, item, key):
        ...
        if not video_id or kind not in ('master', 'playlist'):
            return ''
        try:
            self.yt.cache.pop(video_id, None)
            data = self.yt.extract_live(video_id)
            ...
            if refreshed_url:
                ...
                debug_log('hls target refreshed', {'key': key, 'kind': kind, 'video_id': video_id, 'url_len': len(refreshed_url)})
            return refreshed_url
        except Exception as e:
            debug_log('hls refresh error', {'key': key, 'kind': kind, 'video_id': video_id, 'error': repr(e)})
            return ''
    ...
    def localProxy(self, params):
        ...
        try:
            ...
            debug_log('hls proxy error', {'key': key, 'kind': kind, 'error': repr(e)})
